...
<div class="content-wrapper">
    <section class="content-header d-flex justify-content-between align-items-center header-animado"
        ...
        <h1 style="font-family: 'Poppins', sans-serif; font-weight: 600; color: #fff; margin: 0; font-size: 1.8rem;">
            <i class="fa fa-cube mr-2" style="margin-right: 8px;"></i> Gestión de Roles
        </h1>
        <ol class="breadcrumb" style="top: 15px !important;">
            <li class="breadcrumb-item">
                <button type="button" id="btnRegistrarProfile" class="btn-primary2"><i class="fa fa-plus"></i>
                    Registrar Roles</button>
            </li>
        </ol>
    </section>
...
<script src="{{ asset('auth/js/profiles/index.js') }}"></script>
@endsection