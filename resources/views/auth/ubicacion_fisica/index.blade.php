...
@section('titulo')
<title>Gestión de Ubicación Física</title>
@endsection
...
<div class="content-wrapper">
    ...
    <section class="content-header d-flex justify-content-between align-items-center header-animado"
        ...
        <h1 style="font-family: 'Poppins', sans-serif; font-weight: 600; color: #fff;">
            <i class="fa fa-map-marker mr-2"></i> Gestión de Ubicación Física
        </h1>

        <button id="btnRegistrarUbicacion" class="btn-primary2">
    ...
    <section class="content mt-3">
        <div class="form-section">
            <table id="tableUbicacion" class="table table-bordered table-striped display nowrap margin-top-10"></table>
        </div>
    </section>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h5>Registrar Ubicación Física</h5>
            ...
            <div class="modal-footer">
                <button class="btn btn-primary2" id="guardarUbicacion">Guardar</button>
            </div>
...
<!-- MODAL EDITAR -->
<div class="modal fade" id="modalEditarUbicacion">
    <div class="modal-dialog">
        <div class="modal-content">

            <div class="modal-header">
                <h5>Editar Ubicación Física</h5>
                <button class="close" data-bs-dismiss="modal"><span>×</span></button>
            </div>
            ...
            <div class="modal-footer">
                <button class="btn btn-primary2" id="actualizarUbicacion">Actualizar</button>
            </div>
...
<script src="{{ asset('app/js/ubicacion_fisica/index.js') }}"></script>
@endsection