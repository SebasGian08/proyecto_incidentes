...
class EstadoActivoController extends Controller
{
    ...
    {
        return view('auth.estado_activo.index');
    }

    public function listar()
    {
        $data = \DB::table('maestro_estado_activo')
    ...
    public function store(Request $request)
    {
        ...
        \DB::table('maestro_estado_activo')->insert([
    ...
    public function get($id)
    {
        return response()->json(
            \DB::table('maestro_estado_activo')->where('id', $id)->first()
        );
    }
    ...
    public function update(Request $request)
    {
        ...
        \DB::table('maestro_estado_activo')
            ->where('id', $request->id)
            ->update([
                'nombre' => $request->nombre,
                'updated_at' => now()
