...
class CriticidadController extends Controller
{
    ...
    {
        return view('auth.criticidad.index');
    }

    public function listar()
    {
        $data = \DB::table('maestro_criticidad')
    ...
    public function store(Request $request)
    {
        try {
            ...
            \DB::table('maestro_criticidad')->insert([
    ...
    public function get($id)
    {
        return response()->json(
            \DB::table('maestro_criticidad')->where('id', $id)->first()
        );
    }
